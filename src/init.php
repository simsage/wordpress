 ...
 * @since 1.0.0
 */
function search_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'search-cgb-style-css', // Handle.
	...
	wp_register_style(
		'search-cgb-block-editor-css', // Handle.
		plugins_url( 'dist/blocks.editor.build.css', dirname( __FILE__ ) ), // Block editor CSS.
		array( 'wp-edit-blocks', 'simsage-style-1' ), // Dependency to include the CSS after it.
	 ...
	 */
	register_block_type(
		'simsage/search', array(
		    'title' => 'Simsage search',
			'description' => 'Search form for simsage',
			// Enqueue blocks.style.build.css on both frontend & backend.
			'style'         => 'search-cgb-style-css',
...
// Hook: Block assets.
add_action( 'init', 'search_cgb_block_assets' );
